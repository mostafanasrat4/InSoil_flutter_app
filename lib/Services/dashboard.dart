...
import 'package:insoil_app1/functions.dart';
              ...
              children: List.generate(4, (index){
                return CircularPercentIndicator(
                  ...
                  center: new Text(
                    '${percentages[index]}%',
                    style:
                    new TextStyle(fontWeight: FontWeight.bold, fontSize: 20.0 ,fontFamily: 'Ubuntu',),
                  ),
                  footer: new Text(
                    ingredients[index],
                    style:
                    new TextStyle(fontFamily: 'Ubuntu', fontSize: 17.0 , fontWeight: FontWeight.w600 , color: Colors.blueGrey),
                  ),
